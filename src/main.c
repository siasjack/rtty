...
static RttyMessage *rtty_message_init(RttyMessage__Type type, const char *sid)
{
...
static void rtty_message_send(struct uwsc_client *cl, RttyMessage *msg)
{
